...
public:
	...
	{
		return a1_*(a_ * x_input + b_) + b1_; // returns y = a*x+b
	}
};
...
int main()
{
	...
	for (int tr = 0; tr < 1000; tr++)
		for (int i = 0; i < num_data; i++)
		{
			...
			const float dse_over_db = error*lh.b1_;
	...
	// trained hypothesis
	std::cout << "0.1 " << lh.getY(0.1) << std::endl;
	std::cout << "0.2 " << lh.getY(0.2) << std::endl;
	std::cout << "0.3 " << lh.getY(0.3) << std::endl;
	std::cout << "0.4 " << lh.getY(0.4) << std::endl;
	std::cout << "0.5 " << lh.getY(0.5) << std::endl;
	std::cout << "0.6 " << lh.getY(0.6) << std::endl;
	std::cout << "0.7 " << lh.getY(0.7) << std::endl;
